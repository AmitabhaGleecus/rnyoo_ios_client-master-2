...
- (void)defalutInit
{
    ...
    _titleView.backgroundColor = [Util appHeaderColor];
...
-(void)setListFrame
{
    CGRect tableFrame = CGRectMake(0, 32.0f, self.bounds.size.width, self.bounds.size.height-32.0f);
    _listView.frame = tableFrame;
}
